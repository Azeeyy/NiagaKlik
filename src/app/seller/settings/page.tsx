...
export default function SellerSettingsPage() {
  ...
  if (loading) {
    return (
      <div className="p-8">
        <div className="animate-spin h-8 w-8 border-4 border-secondary-600 border-t-transparent rounded-full mx-auto" />
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      {/* Header */}
      <div className="bg-gradient-to-r from-secondary-600 to-emerald-700 rounded-2xl p-8 mb-8 text-white">
        <h1 className="text-2xl font-bold mb-2">Pengaturan Akun</h1>
        <p className="text-secondary-100">Kelola informasi profil dan keamanan akun penjual Anda</p>
      </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6">
          ...
          <div className="mb-6 p-5 bg-gray-50 rounded-xl">
            ...
            <div className="flex items-center gap-6">
              <div className="relative">
                <div className="w-20 h-20 rounded-full overflow-hidden bg-gradient-to-br from-secondary-400 to-secondary-600 flex items-center justify-center text-white text-2xl font-bold shadow-md">
                  {avatar ? (
          ...
          <form onSubmit={handleProfileSubmit} className="space-y-5">
            ...
            <div className="flex gap-3 pt-2">
              <button type="submit" disabled={saving} className="bg-secondary-600 text-white px-6 py-2.5 rounded-xl font-semibold hover:bg-secondary-700 transition-all disabled:opacity-50">
                {saving ? (
          ...
          <form onSubmit={handlePasswordSubmit} className="space-y-5 max-w-md">
            ...
            <div className="flex gap-3 pt-2">
              <button
                ...
                className="bg-secondary-600 text-white px-6 py-2.5 rounded-xl font-semibold hover:bg-secondary-700 transition-all disabled:opacity-50"
              >
                {saving ? (
                  <span className="flex items-center gap-2">
                    <svg className="animate-spin h-4 w-4" viewBox="0 0 24 24">
